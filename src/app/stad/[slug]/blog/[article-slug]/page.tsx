...
export default async function CityBlogPage({ params }: PageProps) {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://dietistindebuurt.nl/stad/${citySlug}/blog/${articleSlug}`
    },
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="px-8 pb-8">
              <div className="prose prose-lg max-w-none">
                ...
                <p>
                  Zoek naar coaches met een officiële certificering in voedingsadvies. In Nederland zijn dit vaak coaches die zijn aangesloten bij 
                  de Nederlandse Vereniging voor Diëtiek (NVOA) of vergelijkbare organisaties. Veel coaches in {city.name} hebben aanvullende 
                ...
                <p>
                  ...
                  in Diëtiek. Deze lokale connecties kunnen waardevol zijn voor doorverwijzingen en samenwerking in je behandeltraject.
                </p>
                ...
                <p>
                  {city.name} heeft coaches verspreid over verschillende wijken. Populaire locaties voor voedingsadvies praktijken zijn:
                </p>
                <ul>
                ...
                <ul>
                  <li>Hun specifieke ervaring met jouw type Diëtiek-uitdagingen</li>
                ...
                <h2>Kosten van voedingsadvies in {city.name}</h2>
                <p>
                  De kosten voor voedingsadvies in {city.name} variëren afhankelijk van verschillende factoren:
                </p>
                ...
                <p>
                  Hoewel voedingsadvies niet altijd volledig vergoed wordt door de basisverzekering, zijn er wel mogelijkheden:
                </p>
                <ul>
                ...
                <p>
                  Veel volwassenen in {city.name} krijgen pas later in hun leven een Diëtiek-diagnose. Gespecialiseerde coaches helpen bij:
                </p>
                <ul>
                  <li>Werk- en carrièregerelateerde uitdagingen</li>
                  <li>Relatie- en partnerschap problemen</li>
                  <li>Ouderschap met Diëtiek</li>
                ...
                <p>
                  Voor jonge mensen met Diëtiek in {city.name} zijn er coaches die zich richten op:
                </p>
                <ul>
                ...
                <h3>Werkgerelateerde voedingsadvies</h3>
                <p>
                  Gezien de zakelijke drukte in {city.name}, zijn er veel coaches gespecialiseerd in werk-gerelateerde Diëtiek-uitdagingen:
                </p>
                <ul>
                  ...
                  <li>Ondernemerschap met Diëtiek</li>
                </ul>
                ...
                <p>
                  Vergeet niet dat voedingsadvies een investering in jezelf is. Met de juiste begeleiding kun je leren je Diëtiek te 
