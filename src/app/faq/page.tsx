...
const comprehensiveFAQs: FAQItem[] = [
  {
    id: "general-1",
    question: "Wat is een diëtist en wat doet een diëtist?",
    answer: "Een diëtist is een erkend zorgprofessional die gespecialiseerd is in voeding en gezondheid. Diëtisten hebben een HBO-opleiding Voeding en Diëtetiek afgerond en zijn geregistreerd bij de beroepsvereniging Nederlandse Vereniging van Diëtisten (NVD). Ze geven evidence-based voedingsadvies op maat, medische voedingstherapie bij chronische ziekten, begeleiding bij gewichtsmanagement, en helpen bij voedselallergieën, intoleranties en sportvoeding. Diëtisten werken wetenschappelijk onderbouwd en houden rekening met jouw persoonlijke situatie, voorkeuren en gezondheid.",
    category: "Algemeen",
    order: 1
  },
  {
    id: "general-2",
    question: "Wanneer moet ik naar een diëtist?",
    answer: "Je kunt naar een diëtist bij diverse situaties: bij medische aandoeningen zoals diabetes, hoog cholesterol, hart- en vaatziekten, darmproblemen (IBS, Crohn, colitis ulcerosa), nierziekten of kanker. Ook bij gewichtsmanagement (afvallen of aankomen), voedselallergieën of intoleranties, zwangerschap en borstvoeding, sportvoeding, eetproblemen bij kinderen, of als je gewoon gezonder wilt eten. Eigenlijk kun je bij iedere voedingsgerelateerde vraag of uitdaging terecht bij een diëtist.",
    category: "Algemeen",
    order: 2
  },
  {
    id: "costs-1",
    question: "Wat kosten diëtist consulten en wordt het vergoed?",
  ...
  },
  {
    ...
    answer: "Duurzaam gewichtsverlies vraagt tijd en geduld. Een gezond tempo is 0,5-1 kg per week, wat neerkomt op 2-4 kg per maand. Te snel afvallen (meer dan 1 kg per week) verhoogt het risico op het jojo-effect en verlies van spiermassa. De eerste weken zie je vaak sneller resultaat door vochtverlies. Na 3-6 maanden zie je meestal significante veranderingen in gewicht, energie en gezondheid. Een diëtist helpt je realistische doelen te stellen en ondersteunt je bij het volhouden van gezonde gewoonten.",
    category: "Afvallen & Gewicht",
    order: 6
  },
  {
    id: "sports-1",
    question: "Kan een diëtist helpen met sportvoeding?",
    answer: "Ja! Veel diëtisten zijn gespecialiseerd in sportvoeding en kunnen je helpen optimale prestaties te leveren. Ze adviseren over de juiste timing van voeding rondom training, hoeveel koolhydraten, eiwitten en vetten je nodig hebt, supplementen (wel of niet), herstel en hydratatie. Of je nu recreatief sport of topsporter bent, een sportdiëtist stelt een voedingsplan op dat past bij jouw trainingsschema, doelen en sport. Goede voeding kan je prestaties met 10-20% verbeteren.",
    category: "Sportvoeding",
    order: 7
  },
  {
    id: "medical-1",
    question: "Helpt een diëtist bij diabetes?",
    answer: "Absoluut! Dieettherapie is een fundamenteel onderdeel van diabetesbehandeling. Een diëtist leert je hoe koolhydraten je bloedsuiker beïnvloeden, welke voeding je bloedsuikerwaarden stabiel houdt, hoe je kunt genieten van eten zonder pieken en dalen, en hoe voeding en medicatie op elkaar afstemmen. Bij diabetes type 2 wordt dieetbegeleiding standaard vergoed vanuit de basisverzekering (minimaal 3 consulten per jaar). Goede voeding kan insulinegevoeligheid verbeteren en soms medicatie verminderen.",
    category: "Medische Aandoeningen",
    order: 8
  },
  {
    id: "medical-2",
    question: "Kan een diëtist helpen bij een hoog cholesterol?",
    answer: "Ja, een diëtist is dé expert op het gebied van cholesterolverlaging door voeding. Ze adviseren over verzadigde vetten verminderen, meer onverzadigde vetten gebruiken (olijfolie, noten, vette vis), vezels verhogen (havermout, peulvruchten), plantenstanolen/sterolen, en de impact van leefstijl op cholesterol. Vaak kun je met de juiste voedingsaanpassingen je cholesterol met 10-20% verlagen. Bij hart- en vaatziekten of verhoogd cholesterol wordt dieetadvies vaak vergoed vanuit de basisverzekering.",
    category: "Medische Aandoeningen",
    order: 9
  },
  {
    id: "medical-3",
    question: "Helpt een diëtist bij darmproblemen zoals IBS?",
    answer: "Ja! Diëtisten zijn gespecialiseerd in het behandelen van darmproblemen zoals het prikkelbare darm syndroom (IBS), de ziekte van Crohn, colitis ulcerosa, en andere maag-darmklachten. Ze kunnen je begeleiden met een FODMAP-dieet (bewezen effectief bij IBS), identificeren van trigger voedingsmiddelen, zorgen voor voldoende voedingsstoffen ondanks beperkingen, en stapsgewijs voeding herintroduceren. Dieettherapie bij IBS heeft een succespercentage van 70-80% in het verminderen van klachten.",
    category: "Medische Aandoeningen",
    order: 10
  },
  {
    id: "emotional-1",
    question: "Kan een diëtist helpen bij emotioneel eten?",
    answer: "Ja, veel diëtisten zijn opgeleid in gedragsverandering en kunnen helpen bij emotioneel eten. Ze helpen je patronen herkennen (wanneer eet je uit emotie?), onderscheid maken tussen echte honger en emotionele honger, gezonde copingstrategieën ontwikkelen, en een ontspannen relatie met eten opbouwen. Bij ernstige eetproblemen werken diëtisten samen met psychologen of eetstoornisspecialisten. Ze bieden een oordeel-vrije ruimte waar je open kunt praten over je eetgedrag.",
    category: "Emotioneel Eten",
    order: 11
  },
  {
    id: "allergies-1",
    question: "Helpt een diëtist bij voedselallergieën en intoleranties?",
    answer: "Absoluut! Diëtisten zijn experts in het omgaan met voedselallergieën (zoals noten, melk, ei, gluten) en intoleranties (zoals lactose, fructose). Ze helpen met het veilig vermijden van allergenen, zorgen dat je voldoende voedingsstoffen blijft binnenkrijgen, lezen van voedingslabels en verborgen allergenen herkennen, alternatieven vinden voor verboden voedingsmiddelen, en bij kinderen met allergieën een gevarieerd dieet samenstellen. Ze kunnen ook eliminatiediëten begeleiden om intoleranties op te sporen.",
  ...
  },
  {
    ...
    answer: "Een diëtist helpt bij selectief eten door oorzaken te achterhalen (sensorische gevoeligheid, negatieve ervaringen, ontwikkelingsfase), kleine stapjes te zetten zonder druk, speelse benaderingen te gebruiken (samen koken, voedsel verkennen), nieuwe voedingsmiddelen vaak aanbieden (10-15 keer kan nodig zijn), en te zorgen voor voldoende voedingsstoffen ondanks beperkte variatie. Belangrijk is geen dwang gebruiken, eten positief houden, en geduld hebben. Bij ernstige selectieve eetproblemen kan samenwerking met een logopedist of ergotherapeut nodig zijn.",
    category: "Kinderen",
    order: 15
  },
  {
    id: "pregnancy-1",
    question: "Helpt een diëtist tijdens de zwangerschap?",
    answer: "Ja! Voeding tijdens zwangerschap is cruciaal voor moeder en baby. Een diëtist adviseert over voldoende foliumzuur, ijzer, calcium en andere voedingsstoffen, veilige voeding (wat te vermijden), gewichtstoename tijdens zwangerschap (10-16 kg is normaal), misselijkheid en voedingsaversies, zwangerschapsdiabetes, en voorbereiding op borstvoeding. Bij zwangerschapsdiabetes wordt dieetbegeleiding standaard vergoed. Goede voeding tijdens zwangerschap vermindert risico's en bevordert gezonde ontwikkeling van de baby.",
    category: "Zwangerschap",
    order: 16
  },
  {
    id: "pregnancy-2",
    question: "Kan een diëtist helpen bij borstvoeding?",
    answer: "Ja! Een diëtist kan je helpen met de juiste voeding tijdens borstvoeding om te zorgen dat jij en je baby alle benodigde voedingsstoffen binnenkrijgen. Ze adviseren over extra calorieën (ongeveer 500 kcal per dag), voldoende vocht (2-3 liter per dag), belangrijke voedingsstoffen (omega-3, calcium, vitamine D, jodium), voeding die mogelijk koliek veroorzaakt bij de baby, en gezond gewichtsverlies na de bevalling. Goede voeding ondersteunt de melkproductie en je herstel na de zwangerschap.",
    category: "Zwangerschap",
    order: 17
  },
  {
    id: "finding-1",
    question: "Hoe vind ik een goede diëtist bij mij in de buurt?",
    answer: "Je kunt op verschillende manieren een diëtist vinden: via de website van de Nederlandse Vereniging van Diëtisten (NVD) met een zoekfunctie op postcode, via je zorgverzekeraar (lijst van gecontracteerde diëtisten), door aanbeveling van je huisarts of specialist, via online platforms zoals Diëtist in de Buurt, of door reviews te lezen van eerdere cliënten. Controleer altijd of de diëtist geregistreerd is bij de NVD en gekwalificeerd voor jouw specifieke vraag (bijvoorbeeld diabetes, sportvoeding, of kindervoeding).",
    category: "Diëtist Vinden",
    order: 18
  },
  {
    id: "finding-2",
    question: "Wat moet ik vragen bij het eerste gesprek met een diëtist?",
    answer: "Goede vragen voor het eerste gesprek zijn: Bent u gespecialiseerd in mijn specifieke probleem (diabetes, afvallen, IBS)? Hoe ziet een behandeltraject eruit en hoeveel consulten zijn gemiddeld nodig? Wat zijn de kosten en welk deel wordt vergoed? Welke behandelmethoden gebruikt u? Hoe vaak zijn de consulten? Is online begeleiding mogelijk? Werkt u samen met andere zorgverleners (huisarts, specialist)? Belangrijk is ook of je je op je gemak voelt bij de diëtist - een goede klik is essentieel voor succesvol resultaat.",
    category: "Diëtist Vinden",
    order: 19
  },
  {
    id: "finding-3",
    question: "Wat is het verschil tussen een diëtist en een voedingsdeskundige?",
    answer: "Een diëtist is een BIG-geregistreerd zorgprofessional met een HBO-opleiding Voeding en Diëtetiek (4 jaar). Diëtisten mogen medische voedingstherapie geven, werken evidence-based, en hun zorg wordt vergoed door zorgverzekeraars. Een voedingsdeskundige of voedingsadviseur heeft vaak een kortere opleiding en mag geen dieetbehandeling bij ziekte geven. Alleen diëtisten zijn wettelijk erkend als zorgverleners. Voor medische problemen, vergoeding en wetenschappelijk onderbouwd advies kies je altijd een erkende diëtist.",
    category: "Diëtist Vinden",
    order: 20
  }
];

const categories = ["Alle", "Algemeen", "Kosten & Vergoeding", "Afvallen & Gewicht", "Sportvoeding", "Medische Aandoeningen", "Emotioneel Eten", "Allergieën & Intoleranties", "Kinderen", "Zwangerschap", "Diëtist Vinden"];
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-center text-white shadow-xl">
          ...
          <h2 className="text-2xl font-bold mb-3">
            Vind de Perfecte Diëtist bij jou in de Buurt
          </h2>
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Klaar om met een diëtist te starten? Vind gekwalificeerde diëtisten in jouw regio en vergelijk tarieven, specialisaties en reviews.
          </p>
          <Link
            href="/"
