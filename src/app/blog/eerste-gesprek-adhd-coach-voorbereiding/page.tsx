              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-teal-900 mb-2">
                    🧘‍♀️ RELAX: Natuurlijke ondersteuning tijdens coaching
                  </h3>
                  <p className="text-teal-700 mb-3">
                    Nerveus voor je <strong>eerste gesprek ADHD coach</strong>? RELAX helpt je calm en focused te blijven tijdens je coaching journey.
                  </p>
                  <a 
