              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-teal-900 mb-2">
                    🧘‍♀️ RELAX: Ondersteuning tijdens coaching zoektocht
                  </h3>
                  <p className="text-teal-700 mb-3">
                    Voor mensen die online coaching overwegen: ontdek RELAX als natuurlijke ondersteuning tijdens het onderzoek naar de beste coaching optie.
                  </p>
                  <a 
