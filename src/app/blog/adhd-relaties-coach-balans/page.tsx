...
export const metadata: Metadata = {
  ...
  description: 'Diëtiek en relaties: ontdek hoe een coach helpt bij communicatie, begrip en balans vinden. Tips voor betere relaties met Diëtiek.',
  keywords: [
    'Diëtiek en relaties',
    'voedingsadvies relaties',
    'Diëtiek relatieproblemen',
    'Diëtiek partner',
    'relatie coaching Diëtiek',
    'Diëtiek relatie verbeteren coaching',
    'hoe helpt Dietist bij relaties',
    'Diëtiek dating en relaties'
  ],
  openGraph: {
    title: 'Diëtiek en relaties: hoe een coach kan helpen balans te vinden',
    description: 'Diëtiek en relaties: ontdek hoe een coach helpt bij communicatie, begrip en balans vinden. Tips voor betere relaties met Diëtiek.',
...
const articleSchema = {
  ...
  '@type': 'Article',
  headline: 'Diëtiek en relaties',
  description: 'Diëtiek in relaties: van spanningen naar begrip. Complete gids voor partners om samen sterker te worden met voedingsadvies.',
  author: {
    '@type': 'Organization',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://dietistindebuurt.nl/blog/adhd-relaties-coach-balans'
  },
  image: {
    '@type': 'ImageObject',
    url: 'https://dietistindebuurt.nl/img/blog/adhd-relaties-coach-balans/featured.webp',
    width: 800,
    height: 400
  },
  url: 'https://dietistindebuurt.nl/blog/adhd-relaties-coach-balans',
  inLanguage: 'nl-NL'
};

export default function DiëtiekRelatiesCoachBalansPage() {
  ...
  const relationshipPhases = [
    {
      ...
      focus: "Diëtiek disclosure strategieën, verwachtingen afstemmen",
        ...
        <article className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex flex-wrap gap-2">
                  <a 
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://dietistindebuurt.nl/blog/adhd-relaties-coach-balans')}`}
                    target="_blank"
                  ...
                  <a 
                    href={`https://wa.me/?text=${encodeURIComponent('Diëtiek en relaties: hoe een coach kan helpen balans te vinden - https://dietistindebuurt.nl/blog/adhd-relaties-coach-balans')}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a 
                    href={`https://www.messenger.com/t/?link=${encodeURIComponent('https://dietistindebuurt.nl/blog/adhd-relaties-coach-balans')}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a 
                    href={`https://x.com/intent/tweet?text=${encodeURIComponent('Diëtiek en relaties: hoe een coach kan helpen balans te vinden')}&url=${encodeURIComponent('https://dietistindebuurt.nl/blog/adhd-relaties-coach-balans')}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <header className="px-8 pt-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              Diëtiek en relaties: hoe een coach kan helpen balans te vinden
            </h1>
            <p className="text-xl text-gray-600 mb-6">
              Ontdek hoe <strong>voedingsadvies relaties</strong> kan transformeren door betere communicatie, emotieregulatie en wederzijds begrip te ontwikkelen.
            </p>
          ...
          <div className="mx-8 mb-8 bg-gradient-to-r from-rose-50 to-pink-50 border-l-4 border-rose-500 p-6 rounded-r-lg">
            <h2 className="text-lg font-semibold text-rose-900 mb-3 flex items-center">
              ...
              💕 TL;DR: Diëtiek en relaties transformatie
            </h2>
            <div className="text-rose-800 space-y-2">
              <p><strong>Core issue:</strong> <strong>Diëtiek en relaties</strong> creëren unieke uitdagingen door communicatieproblemen, emotieregulatie en betrouwbaarheidsissues.</p>
          ...
          <div className="px-8 prose prose-lg max-w-none">
            <p>
              <strong>Diëtiek en relaties</strong> kunnen een uitdagende combinatie zijn, maar ze hoeven niet destructief te zijn. Met de juiste <strong>voedingsadvies relaties</strong> benadering kunnen partners leren elkaar beter te begrijpen, effectiever te communiceren en een balans te vinden die werkt voor beide individuen.
            </p>

            <p>
              Research toont dat <strong>Diëtiek relatieproblemen</strong> vaak voortkomen uit miscommunicatie en onbegrip over hoe Diëtiek symptoms relationele dynamiek beïnvloeden. Een gespecialiseerde <strong>relatie coaching Diëtiek</strong> aanpak kan deze patronen doorbreken.
            </p>

            <h2>Waarom Diëtiek en relaties een uitdagende combinatie kunnen zijn</h2>
            <p>
              <strong>Diëtiek partner</strong> uitdagingen ontstaan niet uit onwil of gebrek aan liefde, maar uit neurobiologische verschillen die dagelijkse interacties complicated maken.
            </p>
            ...
            <div className="bg-blue-50 p-6 rounded-lg my-6">
              ...
              <div className="mt-4 p-3 bg-white rounded border">
                ...
                <p className="text-blue-800 text-sm">These challenges are symptoms, not character flaws. <strong>Diëtiek relatie verbeteren coaching</strong> helps both partners understand this crucial distinction.</p>
              </div>
            </div>

            <h2>De meest voorkomende relatieproblemen bij Diëtiek</h2>
            <p>
              Nederlandse research over <strong>Diëtiek en relaties</strong> toont consistent terugkerende patronen across different relationship types en levensfases.
            </p>
            ...
            <div className="bg-red-50 p-6 rounded-lg my-6">
              ...
              <p className="text-red-800 text-sm mb-3">Most couples don't realize these are <strong>Diëtiek relatieproblemen</strong> patterns - they interpret them as personal failures of personality incompatibility.</p>
              <div className="bg-white p-3 rounded border">
                <p className="text-red-700 text-sm"><strong>Breaking point:</strong> When partners don't understand Diëtiek connection, kleine issues escalate into relationship-threatening patterns van blame, resentment, en emotional distance.</p>
              </div>
            </div>

            <h2>Hoe Diëtiek symptomen je partnerschap beïnvloeden</h2>
            <p>
              Understanding the specific impact van Diëtiek symptoms op relationship dynamics is de eerste stap naar effective <strong>hoe helpt Dietist bij relaties</strong> intervention.
            </p>
            ...
            <h2>Communicatie verbeteren: wat een Dietist je leert</h2>
            <p>
              Effective communication is de foundation van successful <strong>Diëtiek dating en relaties</strong>. Coaching provides concrete skills om communication gaps te overbruggen.
            </p>
            ...
            <div className="bg-green-50 p-6 rounded-lg my-6">
              ...
              <div className="mt-6 space-y-3">
                <div className="bg-white p-3 rounded border-l-4 border-green-400">
                  <h5 className="font-medium text-green-800 mb-1 text-sm">Active listening voor Diëtiek brains:</h5>
            ...
            <p>
              Emotional regulation is often de biggest challenge in <strong>Diëtiek en relaties</strong>. Intense emotions kunnen overwhelm both partners if not properly managed.
            </p>
            ...
            <div className="bg-purple-50 p-6 rounded-lg my-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-4 rounded border border-purple-200">
                  ...
                  <ul className="text-purple-700 text-sm space-y-1">
                    ...
                    <li>• Developing self-soothing practices that work for Diëtiek</li>
              ...
              <div className="mt-4 p-3 bg-purple-100 rounded">
                <p className="text-purple-900 text-sm"><strong>Key insight:</strong> Diëtiek emotional intensity can become a relationship superpower when properly channeled - creating deeper connection en passion than neurotypical relationships.</p>
              </div>
            </div>

            <h2>Praktische relatievaardigheden die coaching ontwikkelt</h2>
            <p>
              Beyond communication en emotional skills, <strong>relatie coaching Diëtiek</strong> addresses practical daily life skills that make partnerships function smoothly.
            </p>
            ...
            <h2>Cijfers: Diëtiek impact op relaties in Nederland</h2>
            <p>
              Dutch research provides clear evidence about <strong>Diëtiek relatieproblemen</strong> en de effectiveness van targeted coaching interventions.
            </p>

            <div className="bg-orange-50 p-6 rounded-lg my-6">
              <h4 className="font-semibold text-orange-900 mb-3 flex items-center">
                <BarChart3 className="w-5 h-5 mr-2" />
                Nederlandse Diëtiek relationships statistics
              </h4>
              ...
              <div className="bg-white p-4 rounded border">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <div className="bg-orange-100 p-2 rounded text-center">
                    ...
                    <p className="text-orange-800 text-xs">Success rate with alleen Diëtiek partner coaching</p>
                  </div>
                </div>
              </div>

              <div className="mt-4 p-3 bg-orange-100 rounded">
                <p className="text-orange-900 text-sm"><strong>Research insight:</strong> Couples waar both partners understand Diëtiek en participate in solutions have 57% higher relationship satisfaction scores na coaching.</p>
              </div>
            </div>

            <h2>Partner betrekken: wanneer en hoe doe je dit?</h2>
            <p>
              Deciding wanneer en hoe om je <strong>Diëtiek partner</strong> te involve in coaching is crucial voor optimal outcomes in <strong>Diëtiek relatie verbeteren coaching</strong>.
            </p>
              ...
              <div className="space-y-6">
                <div className="bg-white p-4 rounded border-l-4 border-emerald-400">
                  ...
                  <ul className="text-emerald-700 space-y-1 text-sm">
                    ...
                    <li>• Partner is curious en willing om Diëtiek te begrijpen</li>
                    <li>• Communication patterns need systemic change</li>
                    <li>• Both partners zijn gemotiveerd om improvements te maken</li>
                    <li>• Relationship is fundamentally strong but struggling met Diëtiek impact</li>
                  </ul>
                </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <ul className="text-emerald-600 text-xs space-y-1">
                        <li>• Gezamenlijke Diëtiek psychoeducation sessions</li>
                        <li>• Reading materials en resources sharing</li>
                        <li>• Attending Diëtiek workshops together</li>
                        <li>• Learning about Diëtiek strengths as well as challenges</li>
                      </ul>
                    </div>
                ...
                <div className="bg-white p-4 rounded border-l-4 border-red-400">
                  ...
                  <ul className="text-red-700 space-y-1 text-sm">
                    <li>• Partner is resistant of openly critical about Diëtiek</li>
            ...
            <h2>Dating met Diëtiek: timing van disclosure en verwachtingen</h2>
            <p>
              <strong>Diëtiek dating en relaties</strong> presenteren unique challenges around timing van Diëtiek disclosure, managing first impressions, en setting realistic expectations.
            </p>

            <div className="bg-violet-50 p-6 rounded-lg my-6">
              <h4 className="font-semibold text-violet-900 mb-3">💕 Dating coaching for Diëtiek individuals</h4>
              
              <div className="space-y-4">
                <div className="bg-white p-4 rounded border border-violet-200">
                  <h5 className="font-medium text-violet-800 mb-2">Diëtiek disclosure timing strategy:</h5>
              ...
              <div className="mt-4 p-3 bg-violet-100 rounded">
                <p className="text-violet-900 text-sm"><strong>Coaching guidance:</strong> Most successful <strong>Diëtiek dating en relaties</strong> happen wanneer individuals first learn om their Diëtiek effectively te manage solo - then they can bring their best self to partnerships.</p>
              </div>
            </div>

            <h2>Van frustratie naar begrip: de transformatie die coaching brengt</h2>
            <p>
              The journey from frustrated, struggling <strong>Diëtiek en relaties</strong> naar harmonious, understanding partnerships typically follows predictable transformation stages.
            </p>
            ...
            <p>
              Real client transformations demonstrate the power van specialized <strong>voedingsadvies relaties</strong> approach across different relationship stages en challenges.
            </p>
              ...
              <div className="space-y-6">
                <div className="bg-white p-4 rounded border border-amber-200">
                  ...
                  <div className="text-amber-700 text-sm space-y-2">
                    <p><strong>Situation:</strong> 8-jaar marriage, 2 kinderen. Mark's undiagnosed Diëtiek creating constant conflicts over forgotten responsibilities, emotional outbursts, financial mistakes.</p>
                    ...
                    <p><strong>Coaching focus:</strong> Individual Diëtiek management voor Mark, couples communication training, household systems redesign.</p>
                ...
                <div className="bg-white p-4 rounded border border-amber-200">
                  ...
                  <div className="text-amber-700 text-sm space-y-2">
                    ...
                    <p><strong>Challenge:</strong> "Ik was either hiding my Diëtiek en burning out from masking, of being authentic en scaring people away."</p>
                    <p><strong>Coaching focus:</strong> Diëtiek disclosure strategies, emotional regulation voor dating, authenticity zonder overwhelm.</p>
                ...
                <div className="bg-white p-4 rounded border border-amber-200">
                  ...
                  <div className="text-amber-700 text-sm space-y-2">
                    <p><strong>Situation:</strong> Long marriage waar Tom's Diëtiek was seen as "personality quirks." Emma felt increasingly frustrated met miscommunication, forgotten promises.</p>
                    <p><strong>Realization:</strong> Tom's late-in-life Diëtiek diagnosis at 45 suddenly explained decades van patterns. "Everything made sense voor het eerst."</p>
                    ...
                    <p><strong>Outcome:</strong> Emma: "It's like dating again, maar better because we finally understand each other. I wish we'd known about Diëtiek 15 years ago."</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <p>
              <strong>Diëtiek relatie verbeteren coaching</strong> requires different strategies depending op relationship stage, history, en established patterns tussen partners.
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-gray-700 space-y-1 text-sm">
                    ...
                    <li>• Diëtiek education voor both partners early</li>
                ...
                <div>
                  ...
                  <ul className="text-gray-700 space-y-1 text-sm">
                    ...
                    <li>• Relearning each other through Diëtiek lens</li>
            ...
            <h2>Veelgestelde vragen over voedingsadvies en relaties</h2>
            
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Vraag 1: Moet mijn partner altijd involved zijn in mijn voedingsadvies?</h3>
                <p>Not necessarily. Individual coaching can significantly improve <strong>Diëtiek en relaties</strong> door jouw communication skills, emotional regulation, en reliability te verbeteren. However, involving willing partners increases success rates met 57% according tot research.</p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Vraag 2: Hoe vertel ik mijn partner over mijn Diëtiek diagnosis zonder hun weg te jagen?</h3>
                <p>Timing en framing matter. Focus op how understanding Diëtiek will make jullie relationship stronger, niet op problems. Share resources, be open about challenges AND strengths, en emphasize jouw commitment tot growth.</p>
              </div>

              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Vraag 3: Wat als mijn partner denkt dat Diëtiek een excuse is voor bad behavior?</h3>
                <p>This is common initially. <strong>Diëtiek relatieproblemen</strong> require education about Diëtiek as neurobiological difference, not character flaw. Share scientific resources, consider couples sessions, en demonstrate through actions dat je taking responsibility voor management.</p>
              </div>
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Vraag 5: Kunnen we ons relationship save als we beide Diëtiek hebben?</h3>
                <p>Absolutely! <strong>voedingsadvies relaties</strong> with both partners having Diëtiek can be incredibly successful. Focus op understanding each person's unique Diëtiek presentation, creating systems that work for both brains, en celebrating neurodivergent strengths.</p>
              </div>
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Vraag 8: Is het beter om individual voedingsadvies te doen of couples therapy?</h3>
                <p>Depends op situation. Individual coaching is better voor learning Diëtiek management skills first. Couples therapy is better for addressing relationship crisis. Many successful outcomes combine both approaches sequentially.</p>
              </div>
            </div>
            ...
            <div className="my-12 bg-gradient-to-br from-pink-50 to-rose-50 border border-pink-200 rounded-xl p-8 text-center">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                Wil je je relatie versterken? Vind relatie-ervaren voedingsadvies
              </h2>
              <p className="text-lg text-gray-700 mb-6">
                <strong>Diëtiek en relaties</strong> kunnen flourish met de right support, understanding, en practical tools. Specialized coaches understand de unique dynamics en can guide both individual en couple growth.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="text-left">
                  ...
                  <ul className="space-y-1 text-gray-700">
                    <li>• <Link href="/spijkenisse" className="text-pink-600 hover:underline">Dietist in Spijkenisse</Link> - Couples communication specialists</li>
                    <li>• <Link href="/schiedam" className="text-pink-600 hover:underline">Dietist in Schiedam</Link> - Relationship dynamics experts</li>
                    <li>• <Link href="/gouda" className="text-pink-600 hover:underline">Dietist in Gouda</Link> - Partnership balance coaching</li>
                  </ul>
                </div>
                ...
                <div className="text-left">
                  ...
                  <ul className="space-y-1 text-gray-700">
                    <li>• Experience met Diëtiek relationship challenges</li>
              ...
              <div className="bg-white rounded-lg p-6 border border-gray-200">
                <p className="text-xl font-semibold text-gray-900 mb-4">
                  Remember: <strong>Diëtiek relatieproblemen</strong> are not relationship death sentences.
                </p>
                <p className="text-gray-700">
                  Met proper understanding, effective communication tools, en commitment from both partners, <strong>Diëtiek en relaties</strong> can become sources van deep connection, creativity, en mutual growth rather than constant conflict.
                </p>
              </div>
            </div>
          ...
          <div className="px-8 py-8 bg-gray-50 border-t">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/blog/adhd-volwassenen-coaching-vs-medicatie" className="block p-4 bg-white rounded-lg hover:shadow-md transition-shadow">
                <h4 className="font-semibold text-pink-600 mb-2">Diëtiek bij volwassenen: waarom coaching vaak beter helpt dan medicatie alleen</h4>
              ...
              <Link href="/blog/hoe-lang-duurt-adhd-coachtraject" className="block p-4 bg-white rounded-lg hover:shadow-md transition-shadow">
                <h4 className="font-semibold text-pink-600 mb-2">Hoe lang duurt een Dietisttraject gemiddeld?</h4>
