...
const articleSchema = {
  ...
  '@type': 'Article',
  headline: 'ADHD en relaties',
  description: 'ADHD in relaties: van spanningen naar begrip. Complete gids voor partners om samen sterker te worden met ADHD coaching.',
  author: {
    '@type': 'Organization',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://adhdcoachindebuurt.nl/blog/adhd-relaties-coach-balans'
  },
  image: {
    '@type': 'ImageObject',
    url: 'https://adhdcoachindebuurt.nl/img/blog/adhd-relaties-coach-balans/featured.webp',
    width: 800,
    height: 400
  },
  url: 'https://adhdcoachindebuurt.nl/blog/adhd-relaties-coach-balans',
  inLanguage: 'nl-NL'
};
