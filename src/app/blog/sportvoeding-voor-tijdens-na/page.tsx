...
import { Activity, Zap, Timer, Award, Droplet, Apple, CheckCircle2, Clock, TrendingUp, Battery, Flame, AlertCircle, Info } from 'lucide-react';
        ...
        <header className="relative bg-gradient-to-r from-blue-600 to-cyan-500 text-white py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <span className="font-medium">Sportvoeding Gids</span>
            </div>
