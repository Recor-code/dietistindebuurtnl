          ...
          <div className="mt-16 bg-white rounded-xl shadow-md p-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="font-semibold text-blue-900 mb-2">🔍 Coach zoeken & selectie</h3>
                <ul className="text-blue-800 text-sm space-y-1">
                  <li>• Coach vinden in jouw regio</li>
                  <li>• Beste coach kiezen criteria</li>
                  <li>• Vragen voor intake gesprekken</li>
                  <li>• Voorbereiding eerste gesprek</li>
                </ul>
              </div>
              
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="font-semibold text-green-900 mb-2">💝 Relaties & communicatie</h3>
                <ul className="text-green-800 text-sm space-y-1">
                  <li>• ADHD en partnerships</li>
                  <li>• Communicatie verbeteren</li>
                  <li>• Familie coaching tips</li>
                  <li>• Dating met ADHD</li>
                </ul>
              </div>
              
              <div className="bg-purple-50 p-4 rounded-lg">
                <h3 className="font-semibold text-purple-900 mb-2">🎯 Specifieke doelgroepen</h3>
                <ul className="text-purple-800 text-sm space-y-1">
                  <li>• Kinderen & jongeren</li>
                  <li>• Studenten coaching</li>
                  <li>• Professionals & werk</li>
                  <li>• Volwassenen trajecten</li>
                </ul>
              </div>
              
              <div className="bg-orange-50 p-4 rounded-lg">
                <h3 className="font-semibold text-orange-900 mb-2">⏱️ Planning & verwachtingen</h3>
                <ul className="text-orange-800 text-sm space-y-1">
                  <li>• Coaching traject duur</li>
                  <li>• Wanneer hulp zoeken</li>
                  <li>• Online vs persoonlijk</li>
                  <li>• Effectiviteit research</li>
                </ul>
              </div>
              
              <div className="bg-red-50 p-4 rounded-lg">
                <h3 className="font-semibold text-red-900 mb-2">💰 Kosten & praktisch</h3>
                <ul className="text-red-800 text-sm space-y-1">
                  <li>• Coaching kosten 2025</li>
                  <li>• Vergoedingen overzicht</li>
              ...
              <div className="bg-indigo-50 p-4 rounded-lg">
                <h3 className="font-semibold text-indigo-900 mb-2">🧠 Professional insights</h3>
                <ul className="text-indigo-800 text-sm space-y-1">
                  <li>• Coach vs psycholoog</li>
                  <li>• Medicatie combinaties</li>
                  <li>• Success verhalen</li>
                  <li>• Evidence-based tips</li>
                </ul>
              </div>
            </div>
          </div>
