...
import { Scale, Brain, Heart, TrendingDown, TrendingUp, AlertCircle, Coffee, Moon, Users, Target, CheckCircle2, Lightbulb, Calendar, Search } from 'lucide-react';
  ...
  return (
    <>
      ...
      <article className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        {/* Hero Section */}
        <header className="relative bg-gradient-to-r from-blue-600 to-sky-500 text-white py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              <Scale className="w-5 h-5" />
              <span className="font-medium">Gewichtsverlies Gids</span>
            </div>
