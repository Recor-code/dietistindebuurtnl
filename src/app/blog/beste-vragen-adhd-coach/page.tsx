            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <div className="flex items-center text-gray-600">
                  ...
                  <span className="text-sm font-medium">3.1K shares</span>
                </div>
                <div className="flex space-x-2">
                  ...
                  <a 
                    href={`https://wa.me/?text=${encodeURIComponent('De beste vragen om te stellen aan je ADHD coach - https://adhdcoachindebuurt.nl/blog/beste-vragen-adhd-coach')}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a 
                    href={`https://x.com/intent/tweet?text=${encodeURIComponent('De beste vragen om te stellen aan je ADHD coach')}&url=${encodeURIComponent('https://adhdcoachindebuurt.nl/blog/beste-vragen-adhd-coach')}`}
                    target="_blank"
                    rel="noopener noreferrer"
